...
public interface IWalletApi {
    ...
    @Operation(summary = "Get Historical Balance", description = "Retrieve the historical balance of a wallet based on filters.")
    @GetMapping(value = "/transactions/balance")
    ResponseEntity<WalletTransactionBalanceResponse> getHistoricalBalance(TransactionFilterTO filterTO,
